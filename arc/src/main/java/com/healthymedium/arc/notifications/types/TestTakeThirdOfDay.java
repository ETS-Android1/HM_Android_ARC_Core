...
public class TestTakeThirdOfDay extends NotificationType {

    public TestTakeThirdOfDay(){
        super();
        id = 1;
        channelId = "TEST_TAKE_THIRD";
        channelName = "Test Reminder";
        channelDesc = "Notifies user when it is time to take their third test of the day";
    ...
    public String getContent(NotificationNode node) {
        ...
        return ViewUtil.getString(R.string.notification3_default).replace("{TIME}", time);
    }

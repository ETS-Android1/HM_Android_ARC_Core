...
public class SageEarningsControllerTests {
    ...
    val controller = MockSageEarningsController(startDate())
...
open class MockSageEarningsController(
        public var overridingStartDate: DateTime? = null): SageEarningsController() {

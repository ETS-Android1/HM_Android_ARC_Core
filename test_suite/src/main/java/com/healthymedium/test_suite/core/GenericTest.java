...
public class GenericTest extends BaseTest {
    ...
    public void setupLocale(){
        ...
        java.util.Locale javaLocale = ConfigurationCompat.getLocales( InstrumentationRegistry.getInstrumentation().getTargetContext().getResources().getConfiguration()).get(0);
        ...
        Application.getInstance().updateLocale(InstrumentationRegistry.getInstrumentation().getContext());
    ...
    public void test(){
        ...
        while (TestBehavior.STEPS > 0 ) {
            ...
            Log.v(tag, "steps: " + TestBehavior.STEPS + "        performing behavior for " + fragmentName);
